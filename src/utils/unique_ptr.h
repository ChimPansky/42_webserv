...
class unique_ptr {
  public:
    ...
    inline ~unique_ptr() throw() { destroy_(); }

    inline void reset() throw() { destroy_(); }
    ...
    inline operator bool() const throw() { return (NULL != raw_ptr_); }
    ...
    inline T* get() const throw() { return raw_ptr_; }
